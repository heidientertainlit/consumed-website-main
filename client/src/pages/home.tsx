        ...
        <section className="pt-32 md:pt-40 pb-4 md:pb-6 relative overflow-visible z-10" id="features">
          <div className="container mx-auto max-w-7xl px-6 grid lg:grid-cols-[1.15fr_0.85fr] items-center gap-12 lg:gap-20 xl:gap-24 relative -translate-y-3 md:-translate-y-4">
            ...
            >
              ...
              <h1 className="mt-2 font-sans text-[10px] font-light uppercase leading-relaxed tracking-[0.2em] text-foreground/65 sm:text-xs">
                The social app for all your entertainment.
              </h1>
              <p className="mb-6 mt-4 max-w-2xl text-sm leading-relaxed text-foreground/90 md:text-base">
